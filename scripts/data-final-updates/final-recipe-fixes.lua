...
local recipes = {"ei_desulfurize-kerosene", "ei_kerosene:heavy-oil", "ei_hydrofluoric-acid", "ei_kerosene-cracking",
                 "ei_nitric-acid", "ei_crystal-solution", "ei_drill-fluid", "ei_ammonia", "ei_dinitrogen-tetroxide",
                 "ei_dinitrogen-tetroxide-water-solution", "ei_oxygen-difluoride", -- "ei_lube-destilation",
"ei_plastic:benzol", "ei_battery:lithium", "ei_carbon", "ei_lithium-crystal", "ei_molten-steel:mix", "ei_steam-engine",
                 "ei_electron-tube", "ei_cpu", "ei_electronic-parts", "ei_module-part", "ei_module-base", "ei_magnet",
                 "ei_emtpy-cryo-container", "ei_green-circuit:waver", "ei_red-circuit:waver", "ei_electric-engine:lube",
                 "ei_advanced-motor", "ei_rocket-parts", "ei_dark-age-tech", "ei_steam-age-tech",
                 "ei_electricity-age-tech", "ei_computer-age-tech", "ei_advanced-computer-age-tech",
                 "ei_quantum-age-tech", "ei_ceramic", "ei_steel-blend", "ei_dirty-water:fluorite",
                 "ei_neutron-container", "ei_odd-plating", "ei_advanced-rocket-fuel", "ei_plastic:crushed-coke",
                 "ei_rocket-parts:odd-plating", "ei_insulated-wire", "firearm-magazine", "piercing-rounds-magazine",
                 "uranium-rounds-magazine", "ei_compound-ammo", "shotgun-shell", "piercing-shotgun-shell",
                 "cannon-shell", "explosive-cannon-shell", "uranium-cannon-shell", "explosive-uranium-cannon-shell",
                 "artillery-shell", "rocket", "explosive-rocket", "ei_molten-steel:oxygen", "ei_neodym-plate",
                 "ei_ceramic:water", "ei_solid-fuel:residual-oil", "ei_diesel-fuel-unit", "ei_benzol:petroleum"}

local remove_prod = {"iron-plate", "copper-plate"}

local crafting_categories = {"ei_waver-factory", "smelting", "rocket-building"}
