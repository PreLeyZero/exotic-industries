...
local new_ingredients_table = {
    ["iron-plate"] = {{"ei_iron-ingot", 1}},
    ["copper-plate"] = {{"ei_copper-ingot", 1}},
    ["transport-belt"] = {{"iron-plate", 1}, {"ei_iron-mechanical-parts", 2}},
    ["burner-inserter"] = {{"iron-plate", 1}, {"ei_copper-mechanical-parts", 2}},
    ["repair-pack"] = {{"ei_copper-mechanical-parts", 3}, {"ei_iron-mechanical-parts", 3}},
    ["iron-chest"] = {{"iron-plate", 8}, {"ei_iron-beam", 2}},
    ["gun-turret"] = {{"iron-plate", 5}, {"ei_iron-mechanical-parts", 5}, {"ei_copper-mechanical-parts", 5}},
    ["heavy-armor"] = {{"iron-plate", 40}, {"ei_iron-beam", 10}, {"ei_copper-beam", 10}},
    ["stone-wall"] = {{"stone-brick", 3}, {"ei_iron-beam", 1}},
    ["offshore-pump"] = {{"ei_copper-mechanical-parts", 4}, {"ei_iron-beam", 2}, {"pipe", 2}},
    ["train-stop"] = {{"ei_iron-beam", 2}, {"ei_iron-mechanical-parts", 2}, {"copper-plate", 2}},
    ["rail-signal"] = {{"ei_copper-mechanical-parts", 1}, {"iron-plate", 1}},
    ["rail-chain-signal"] = {{"ei_copper-mechanical-parts", 1}, {"iron-plate", 1}},
    ["steel-furnace"] = {{"steel-plate", 4}, {"stone-brick", 10}, {"stone-furnace", 1}},
    ["gate"] = {{"stone-wall", 1}, {"ei_iron-beam", 2}, {"ei_copper-mechanical-parts", 4}},
    ["oil-refinery"] = {{"pipe", 10}, {"ei_copper-beam", 20}, {"steel-plate", 15}, {"ei_steel-mechanical-parts", 10},
                        {"stone-brick", 10}},
    ["engine-unit"] = {{"ei_steam-engine", 1}, {"ei_copper-mechanical-parts", 1}, {"ei_iron-mechanical-parts", 1}},
    ["lab"] = {{"ei_dark-age-lab", 1}, {"ei_copper-mechanical-parts", 10}, {"ei_iron-mechanical-parts", 10},
               {"electronic-circuit", 10}},
    ["electric-engine-unit"] = {{"engine-unit", 1}, {"copper-cable", 4}, {"ei_iron-mechanical-parts", 2}},
    ["steam-engine"] = {{"pipe", 5}, {"electric-engine-unit", 4}, {"ei_steam-engine", 4}, {"ei_iron-beam", 2}},
    ["inserter"] = {{"electric-engine-unit", 1}, {"burner-inserter", 1}, {"electronic-circuit", 2}},
    ["medium-electric-pole"] = {{"ei_copper-beam", 4}, {"ei_iron-mechanical-parts", 2}, {"ei_insulated-wire", 2}},
    ["big-electric-pole"] = {{"steel-plate", 8}, {"ei_iron-mechanical-parts", 2}, {"ei_insulated-wire", 4}},
    ["substation"] = {{"steel-plate", 6}, {"ei_insulated-wire", 6}, {"electronic-circuit", 6}, {"concrete", 25}},
    ["concrete"] = {{"ei_poor-iron-chunk", 5}, {"stone-brick", 10}, {"ei_sand", 4}},
    ["assembling-machine-1"] = {{"electronic-circuit", 2}, {"electric-engine-unit", 2}, {"ei_iron-beam", 2},
                                {"ei_copper-mechanical-parts", 4}},
    ["chemical-plant"] = {{"ei_heat-chemical-plant", 1}, {"electronic-circuit", 2}, {"electric-engine-unit", 2}},
    ["roboport"] = {{"advanced-circuit", 45}, {"concrete", 50}, {"ei_steel-mechanical-parts", 45}, {"steel-plate", 45}},
    ["logistic-robot"] = {{"advanced-circuit", 4}, {"steel-plate", 4}, {"flying-robot-frame", 1}},
    ["construction-robot"] = {{"electronic-circuit", 4}, {"steel-plate", 4}, {"flying-robot-frame", 1}},
    ["modular-armor"] = {{"advanced-circuit", 25}, {"heavy-armor", 1}, {"iron-plate", 25}},
    ["exoskeleton-equipment"] = {{"ei_steel-mechanical-parts", 10}, {"advanced-circuit", 10},
                                 {"electric-engine-unit", 25}},
    ["discharge-defense-equipment"] = {{"advanced-circuit", 10}, {"steel-plate", 10}, {"ei_insulated-wire", 45}},
    ["power-armor"] = {{"modular-armor", 1}, {"electric-engine-unit", 40}, {"advanced-circuit", 40},
                       {"ei_energy-crystal", 100}},
    ["energy-shield-equipment"] = {{"advanced-circuit", 10}, {"steel-plate", 10}, {"ei_energy-crystal", 25}},
    ["personal-laser-defense-equipment"] = {{"laser-turret", 6}, {"steel-plate", 10}, {"ei_energy-crystal", 25}},
    ["laser-turret"] = {{"steel-plate", 20}, {"advanced-circuit", 10}, {"battery", 12}, {"ei_energy-crystal", 10}},
    ["solar-panel"] = {{"ei_semiconductor", 1}, {"steel-plate", 4}, {"electronic-circuit", 8}},
    ["electric-furnace"] = {{"copper-cable", 40}, {"ei_steel-mechanical-parts", 10}, {"electronic-circuit", 10},
                            {"steel-furnace", 1}},
    ["radar"] = {{"electronic-circuit", 5}, {"steel-plate", 6}, {"ei_iron-mechanical-parts", 10},
                 {"electric-engine-unit", 4}},
    ["electric-mining-drill"] = {{"electric-engine-unit", 4}, {"electronic-circuit", 4}, {"ei_iron-beam", 3},
                                 {"ei_iron-mechanical-parts", 5}},
    ["storage-tank"] = {{"steel-plate", 8}, {"ei_iron-beam", 4}, {"pipe", 4}},
    ["splitter"] = {{"transport-belt", 1}, {"ei_iron-mechanical-parts", 5}},
    ["underground-belt"] = {{"transport-belt", 5}, {"ei_iron-mechanical-parts", 10}},
    ["nuclear-reactor"] = {{"concrete", 250}, {"ei_lead-plate", 150}, {"advanced-circuit", 250},
                           {"ei_energy-crystal", 100}, {"steel-plate", 150}, {"ei_fission-tech", 100}},
    ["heat-pipe"] = {{"ei_basic-heat-pipe", 1}, {"ei_energy-crystal", 1}, {"steel-plate", 5}},
    ["centrifuge"] = {{"advanced-circuit", 10}, {"ei_steel-mechanical-parts", 20}, {"ei_lead-plate", 10},
                      {"electric-engine-unit", 15}, {"ei_energy-crystal", 15}},
    ["steam-turbine"] = {{"pipe", 10}, {"ei_steam-engine", 25}, {"ei_steel-mechanical-parts", 50}, {"copper-plate", 50}},
    ["accumulator"] = {{"steel-plate", 6}, {"battery", 5}, {"plastic-bar", 2}},
    ["stack-inserter"] = {{"ei_electronic-parts", 5}, {"ei_advanced-motor", 4}, {"fast-inserter", 1},
                          {"ei_energy-crystal", 4}},
    ["effectivity-module"] = {{"ei_module-base", 1}, {"ei_energy-crystal", 4}},
    ["productivity-module"] = {{"ei_module-base", 1}, {"advanced-circuit", 4}},
    ["effectivity-module-2"] = {{"ei_simulation-data", 25}, {"ei_module-base", 1}, {"effectivity-module", 2}},
    ["productivity-module-2"] = {{"ei_simulation-data", 25}, {"ei_module-base", 1}, {"productivity-module", 2}},
    ["speed-module-2"] = {{"ei_simulation-data", 25}, {"ei_module-base", 1}, {"speed-module", 2}},
    ["assembling-machine-3"] = {{"assembling-machine-2", 2}, {"ei_advanced-motor", 10}, {"ei_electronic-parts", 6}},
    ["processing-unit"] = {{"ei_electronic-parts", 1}, {"ei_advanced-semiconductor", 1}, {"ei_simulation-data", 4},
                           {"ei_crushed-gold", 8}},
    ["effectivity-module-3"] = {{"processing-unit", 2}, {"ei_module-base", 1}, {"effectivity-module-2", 2}},
    ["productivity-module-3"] = {{"processing-unit", 2}, {"ei_module-base", 1}, {"productivity-module-2", 2}},
    ["speed-module-3"] = {{"processing-unit", 2}, {"ei_module-base", 1}, {"speed-module-2", 2}},
    ["rocket-control-unit"] = {{"processing-unit", 1}, {"ei_high-energy-crystal", 1}, {"ei_insulated-wire", 6}},
    ["rocket-part"] = {{"ei_rocket-parts", 10}, {"rocket-fuel", 10}},
    ["satellite"] = {{"rocket-fuel", 20}, {"ei_rocket-parts", 5}, {"solar-panel", 6}, {"ei_high-energy-crystal", 10},
                     {"radar", 5}},
    ["spidertron"] = {{"tank", 1}, {"ei_steel-mechanical-parts", 100}, {"ei_advanced-motor", 100},
                      {"ei_high-energy-crystal", 40}, {"ei_electronic-parts", 40}, {"ei_simulation-data", 100}},
    ["spidertron-remote"] = {{"radar", 1}, {"advanced-circuit", 1}},
    ["power-armor-mk2"] = {{"power-armor", 1}, {"low-density-structure", 40}, {"processing-unit", 60},
                           {"ei_high-energy-crystal", 40}},
    ["express-transport-belt"] = {{"fast-transport-belt", 1}, {"ei_steel-mechanical-parts", 10}, {
        type = "fluid",
        name = "lubricant",
        amount = 15
    }},
    ["express-underground-belt"] = {{"fast-underground-belt", 2}, {"ei_steel-mechanical-parts", 30}, {
        type = "fluid",
        name = "lubricant",
        amount = 35
    }},
    ["express-splitter"] = {{"fast-splitter", 1}, {"advanced-circuit", 10}, {"ei_steel-mechanical-parts", 15}, {
        type = "fluid",
        name = "lubricant",
        amount = 55
    }},
    ["firearm-magazine"] = {{"ei_iron-mechanical-parts", 2}},
    ["piercing-rounds-magazine"] = {{"firearm-magazine", 1}, {"ei_copper-mechanical-parts", 2},
                                    {"ei_steel-mechanical-parts", 3}},
    ["shotgun-shell"] = {{"ei_iron-mechanical-parts", 1}, {"ei_copper-mechanical-parts", 2}},
    ["piercing-shotgun-shell"] = {{"shotgun-shell", 1}, {"ei_steel-mechanical-parts", 3},
                                  {"ei_copper-mechanical-parts", 2}},
    ["rocket-silo"] = {{"processing-unit", 200}, {"ei_steel-mechanical-parts", 200}, {"steel-plate", 200},
                       {"concrete", 1000}, {"ei_advanced-motor", 50}},
    ["fusion-reactor-equipment"] = {{"ei_carbon-structure", 50}, {"processing-unit", 200}, {"ei_fusion-data", 50},
                                    {"ei_charged-neutron-container", 10}},
    ["arithmetic-combinator"] = {{"electronic-circuit", 2}, {"copper-cable", 3}},
    ["decider-combinator"] = {{"electronic-circuit", 2}, {"copper-cable", 3}},
    ["cannon-shell"] = {{"ei_iron-beam", 1}, {"ei_ceramic", 2}, {"plastic-bar", 1}},
    ["explosive-cannon-shell"] = {{"cannon-shell", 1}, {"explosives", 2}},
    ["artillery-shell"] = {{"explosive-cannon-shell", 4}, -- {"ei_high-energy-crystal", 1},
    {"ei_electronic-parts", 2}, {"explosives", 8}, {"radar", 1}}
}
...
data.raw["recipe"]["burner-mining-drill"].normal.ingredients =
    {{"iron-plate", 3}, {"ei_iron-mechanical-parts", 3}, {"stone-furnace", 1}}

data.raw["recipe"]["burner-mining-drill"].expensive.ingredients =
    {{"iron-plate", 3}, {"ei_iron-mechanical-parts", 3}, {"stone-furnace", 1}}

data.raw["recipe"]["pipe"].normal.ingredients = {{"iron-plate", 1}, {"ei_iron-mechanical-parts", 1}}

data.raw["recipe"]["pipe"].expensive.ingredients = {{"iron-plate", 2}, {"ei_iron-mechanical-parts", 2}}

data.raw["recipe"]["electronic-circuit"].normal.ingredients =
    {{"ei_electron-tube", 1}, {"copper-cable", 2}, {"iron-plate", 1}}
...
ei_lib.recipe_new("flying-robot-frame",
    {{"electric-engine-unit", 4}, {"battery", 2}, {"advanced-circuit", 5}, {"ei_steel-mechanical-parts", 10},
     {"ei_energy-crystal", 1}, {
        type = "fluid",
        name = "lubricant",
        amount = 100
...
ei_lib.recipe_new("speed-module", {{"ei_module-base", 1}, {
    type = "fluid",
...
ei_lib.recipe_new("rocket-fuel", {{"solid-fuel", 10}, {
    type = "fluid",
    name = "ei_kerosene",
    amount = 15
}, {
...
new_prerequisites_table["steam-age"] = {{"refined-flammables-1", "flammables"},
                                        {"refined-flammables-2", "refined-flammables-1"},
                                        {"flamethrower", "flammables"}, {"flammables", "ei_steam-oil-processing"},
...
-- {"fluid-wagon", "railway"},
                                        ...
                                        {"braking-force-2", "braking-force-1"}, -- {"fluid-wagon", "fluid-handling"},
{"stronger-explosives-1", "military-2"}, {"gate", "military-2"}, {"automobilism", "military-2"},
                                        {"automobilism", "engine"}, {"flammables", "military-2"},
                                        {"flammethrower", "steel-processing"}, {"flammethrower", "engine"},
...
-- {"fluid-handling", "steel-processing"},
                                        {"military-2", "steel-processing"}, {"steel-axe", "steel-processing"},
                                        {"engine", "ei_steam-oil-processing"}, {"electronics", "ei_glass"}}

new_prerequisites_table["electricity-age"] = {{"electric-energy-distribution-1", "plastics"},
                                              {"electric-energy-distribution-2", "plastics"},
                                              {"electric-energy-distribution-2", "concrete"},
                                              {"automation", "ei_electricity-power"}, {"automation-2", "automation"},
                                              {"fast-inserter", "ei_electricity-power"},
                                              {"circuit-network", "ei_electricity-power"},
                                              {"optics", "ei_electricity-power"}, {"laser", "optics"},
                                              {"laser-turret", "laser"}, {"energy-weapons-damage-1", "laser"},
                                              ...
                                              {"laser", "military-3"}, {"tank", "military-3"},
                                              {"physical-projectile-damage-3", "military-3"},
                                              {"land-mine", "military-3"}, {"stronger-explosives-2", "military-3"},
                                              ...
                                              {"robotics", "lubricant"}, {"robotics", "advanced-electronics"},
                                              {"robotics", "battery"}, {"robotics", "ei_grower"},
                                              {"logistic-robotics", "robotics"}, {"construction-robotics", "robotics"},
...
-- {"logistic-system", "construction-robotics"},
                                              {"defender", "robotics"}, {"distractor", "defender"},
                                              {"destroyer", "distractor"}, {"follower-robot-count-1", "defender"},
                                              {"follower-robot-count-2", "follower-robot-count-1"},
                                              {"modular-armor", "military-3"}, {"power-armor", "modular-armor"},
                                              {"braking-force-3", "railway"}, {"fluid-wagon", "railway"},
                                              {"lubricant", "ei_destill-tower"}, {"railway", "fluid-handling"},
                                              {"railway", "sulfur-processing"}, {"braking-force-4", "braking-force-3"},
                                              ...
                                              {"sulfur-processing", "ei_destill-tower"}, {"oil-processing", "plastics"},
                                              ...
                                              {"lubricant", "automation-2"}, {"logistics-2", "plastics"},
                                              {"advanced-electronics", "sulfur-processing"},
                                              {"advanced-electronics", "automation-2"},
                                              {"inserter-capacity-bonus-2", "lubricant"},
                                              {"construction-robotics", "concrete"}, {"logistic-robotics", "concrete"},
                                              {"explosives", "sulfur-processing"}, {"military-3", "explosives"},
                                              ...
                                              {"laser", "ei_grower"}, {"laser", "advanced-electronics"},
                                              {"personal-roboport-equipment", "modular-armor"},
                                              {"power-armor", "ei_grower"}, {"solar-energy", "ei_waver-factory"},
...
-- {"nuclear-fuel-processing", "nuclear-power"},
                                              {"uranium-ammo", "uranium-processing"}, {"uranium-ammo", "tank"}}

new_prerequisites_table["computer-age"] = {{"inserter-capacity-bonus-3", "stack-inserter"},
                                           {"inserter-capacity-bonus-4", "inserter-capacity-bonus-3"},
                                           {"speed-module", "modules"}, {"speed-module-2", "speed-module"},
                                           {"speed-module-3", "speed-module-2"}, {"speed-module-2", "ei_computer-core"},
...
-- {"advanced-electronics-2", "ei_computer-core"},
                                           ...
                                           {"braking-force-7", "braking-force-6"}, {"braking-force-6", "logistics-3"},
                                           {"automation-3", "ei_cryodust"}, {"automation-3", "ei_bio-reactor"},
                                           {"rocket-silo", "automation-3"}, {"logistics-3", "automation-3"},
                                           {"mining-productivity-2", "ei_advanced-computer-age-tech"},
                                           {"stack-inserter", "logistics-3"}, {"logistic-system", "ei_computer-core"},
                                           ...
                                           {"research-speed-4", "research-speed-3"}, {"artillery", "rocketry"},
                                           {"artillery", "ei_high-energy-crystal"},
                                           {"artillery", "ei_advanced-computer-age-tech"}, {"spidertron", "rocketry"},
                                           {"spidertron", "ei_computer-core"}, {"spidertron", "ei_high-energy-crystal"},
                                           {"spidertron", "automation-3"}, {"rocketry", "military-4"},
                                           {"explosive-rocketry", "rocketry"}, {"artillery-shell-range-1", "artillery"},
...
-- {"stronger-explosives-3", "military-4"},
                                           ...
                                           {"rocket-fuel", "refined-flammables-6"}, {"rocket-fuel", "ei_oxygen-gas"},
                                           {"rocket-control-unit", "advanced-electronics-2"},
                                           {"rocket-control-unit", "ei_high-energy-crystal"},
                                           {"ei_rocket-parts", "rocket-fuel"}, {"rocket-silo", "ei_rocket-parts"},
                                           {"advanced-electronics-2", "ei_advanced-computer-age-tech"}}

new_prerequisites_table["quantum-age"] = {{"mining-productivity-4", "mining-productivity-3"},
...
-- add burnt fuel slot
data.raw["locomotive"]["locomotive"].burner.fuel_categories = {"ei_diesel-fuel", "ei_rocket-fuel"}
...
data.raw["reactor"]["nuclear-reactor"].picture.layers[1].hr_version.filename = ei_graphics_entity_path ..
                                                                                   "hr-reactor.png"
data.raw["reactor"]["nuclear-reactor"].working_light_picture.hr_version.filename = ei_graphics_entity_path ..
...
data.raw["reactor"]["nuclear-reactor"].working_light_picture.filename = ei_graphics_entity_path ..
...
data.raw["mining-drill"]["burner-mining-drill"].radius_visualisation_picture =
    data.raw["mining-drill"]["electric-mining-drill"].radius_visualisation_picture
...
local cannon_shell_projectiles = {"cannon-projectile", "explosive-cannon-projectile",
                                  "explosive-uranium-cannon-projectile", "uranium-cannon-projectile"}
...
-- hide unused items
local unused_items = {"iron-ore", "copper-ore", "uranium-ore", "automation-science-pack", "logistic-science-pack",
                      "military-science-pack", "chemical-science-pack", "production-science-pack",
                      "utility-science-pack", "space-science-pack", -- "uranium-235",
-- "uranium-238",
"nuclear-fuel", "uranium-fuel-cell", "used-up-uranium-fuel-cell", "iron-stick", "iron-gear-wheel", "beacon"}
        ...
        for _, recipe in pairs(data.raw["recipe"]) do
            ...
            if recipe.name == "fill-" .. item.name then
                recipe.ingredients = {{
                    type = "fluid",
                    name = fluid,
                    amount = 500 * ei_lib.config("barrel:multiplier")
                }, {
                    type = "item",
                    name = "empty-barrel",
                    amount = 1
