...
ei_lib.recipe_new("sp-spiderling",
    {{"advanced-circuit", 10}, {"ei_energy-crystal", 20}, {"electric-engine-unit", 20},
     {"ei_steel-mechanical-parts", 45}, {"radar", 6}})

-- adjust spidertron
ei_lib.recipe_swap("spidertron", "tank", "sp-spiderling")

-- adjust spidertron automation tech
data.raw["technology"]["sp-spidertron-automation"].prerequisites =
    {"sp-spiderling", "logistic-robotics", "construction-robotics", "ei_electronic-parts"}

ei_lib.recipe_new("sp-spidertron-dock",
    {{"ei_electronic-parts", 10}, {"radar", 1}, {"steel-plate", 6}, {"ei_copper-mechanical-parts", 12}})
