...
local tech_table = {
    ["steam-age"] = {"nanobots", "nanobots-cliff", "nano-speed-1", "nano-speed-2", "nano-range-1", "nano-range-2"},
    ["electricity-age"] = {"nano-speed-3", "nano-speed-4", "nano-range-3", "nano-range-4"}
}
