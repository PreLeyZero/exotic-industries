...
function make_loaders {
    # build exotic-industries-dev container mod
    Write-ColorOutput green ("Building loader mod...")
    ...
    # $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries_'} | %{$_.FullName}
    $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries-loaders_'} | %{$_.FullName}
    ...
    {
        throw "There is more then one uniqe exotic-industries-loaders folder in this repository."
    }
    ...
    $SourceTarget = Join-Path -Path $FactorioFolder -ChildPath (-join("exotic-industries-loaders_", $SourceVersion))
...
function make_robots {
    # build exotic-industries-dev container mod
    Write-ColorOutput green ("Building robots mod...")
    ...
    # $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries_'} | %{$_.FullName}
    $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries-robots_'} | %{$_.FullName}
    ...
    {
        throw "There is more then one uniqe exotic-industries-robots folder in this repository."
    }
    ...
    $SourceTarget = Join-Path -Path $FactorioFolder -ChildPath (-join("exotic-industries-robots_", $SourceVersion))
...
function make_modpack {
    ...
    # $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries_'} | %{$_.FullName}
    $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries-modpack_'} | %{$_.FullName}
    ...
    {
        throw "There is more then one uniqe exotic-industries-modpack folder in this repository."
    }
    ...
    $SourceTarget = Join-Path -Path $FactorioFolder -ChildPath (-join("exotic-industries-modpack_", $SourceVersion))
...
function make_fueler {
    Write-ColorOutput green ("Building fueler mod...")
    ...
    # $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries_'} | %{$_.FullName}
    $SourceArray = Get-ChildItem -Path $ParentPath -Recurse | Where {$_.Name -match 'exotic-industries-fueler_'} | %{$_.FullName}
    ...
    {
        throw "There is more then one uniqe exotic-industries-fueler folder in this repository."
    }
    ...
    $SourceTarget = Join-Path -Path $FactorioFolder -ChildPath (-join("exotic-industries-fueler_", $SourceVersion))
