...
data:extend({{
    ...
    category = "smelting",
    energy_required = 3.2,
    ingredients = {{"ei_poor-iron-chunk", 1}},
    results = {{
        type = "item",
        name = "ei_iron-ingot",
        amount = 1
    ...
    category = "smelting",
    energy_required = 3.2,
    ingredients = {{"ei_poor-copper-chunk", 1}},
    results = {{
        type = "item",
        name = "ei_copper-ingot",
        amount = 1
    ...
    category = "crafting",
    energy_required = 0.5,
    ingredients = {{"ei_iron-ingot", 1}, {"ei_copper-ingot", 1}},
    results = {{
        type = "item",
        name = "ei_dark-age-tech",
        amount = 2
    ...
    category = "crafting",
    energy_required = 1.5,
    ingredients = {{"ei_copper-mechanical-parts", 1}, {"pipe", 1}},
    results = {{
        type = "item",
        name = "ei_steam-engine",
        amount = 1
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"ei_copper-mechanical-parts", 4}, {"ei_steam-engine", 1}},
    results = {{
        type = "item",
        name = "ei_steam-age-tech",
        amount = 2
