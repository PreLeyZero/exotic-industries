...
data:extend({{
    ...
    category = "crafting",
    energy_required = 30,
    ingredients = {{"concrete", 100}, {"ei_electronic-parts", 200}, {"battery", 200}, {"ei_high-energy-crystal", 50},
                   {"steel-plate", 200}, {"ei_steel-mechanical-parts", 100}},
    result = "ei_gate",
    result_count = 1,
    enabled = false,
    ...
    health = 3000,
    minable = {
        mining_time = 1 --[[result = "ei_gate"]]
    },
    flags = {"not-blueprintable", "not-on-map", "not-flammable", "not-repairable", "not-upgradable", "hidden",
             "hide-alt-info", "not-deconstructable"},
    collision_box = {{-5.4, -5.4}, {5.4, 5.4}},
