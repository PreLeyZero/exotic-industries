...
data:extend({ -- ROCKETS
{
    ...
    energy_required = 4,
    ingredients = {{"rocket-fuel", 10}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"rocket-fuel", 12}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"ei_advanced-rocket-fuel", 16}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"ei_advanced-rocket-fuel", 26}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"ei_advanced-rocket-fuel", 18}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"ei_advanced-rocket-fuel", 24}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
    ...
    category = "rocket-building",
    energy_required = 4,
    ingredients = {{"ei_advanced-rocket-fuel", 20}, {"ei_carbon-structure", 2}, {"ei_rocket-parts", 10}},
    result = "rocket-part",
    result_count = 1,
    enabled = false,
    hidden = true,
...
}, -- TECHS
{
    ...
    icon_size = 512,
    prerequisites = {"ei_mars-exploration", "ei_uran-exploration", "ei_gas-giant-exploration", "ei_sulf-exploration",
                     "ei_sun-exploration", "ei_fusion-drive"},
    effects = {},
    unit = {
        count = 100,
...
}, -- RECIPES
{
    ...
    results = {{
        ...
        amount = 10,
        probability = 0.05
    } -- one rocket (for 10/s at he3 lowest injection: 3.7 GW) = 10000 * 0.05 = 500 He3 = 500 * 5 plasma = 2500 plasma -> 250/s (4.1 min) at low, 50 s at high 
    },
