...
-- ITEMS
------------------------------------------------------------------------------------------------------
data:extend({ -- new module tier 4-6
{
...
data:extend({{
    ...
    category = "crafting",
    energy_required = 20,
    ingredients = {{"ei_minigun", 10}, {"ei_carbon-structure", 25}, {"ei_odd-plating", 25}, {"ei_advanced-motor", 100}},
    ...
    category = "crafting",
    energy_required = 20,
    ingredients = {{"discharge-defense-equipment", 20}, {"ei_carbon-structure", 25}, {"ei_high-tech-parts", 25}},
    ...
    category = "crafting",
    energy_required = 20,
    ingredients = {{"discharge-defense-remote", 1}},
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"energy-shield-mk2-equipment", 6}, {"ei_carbon-structure", 10}, {"ei_superior-data", 25}},
    ...
    results = {{
        type = "fluid",
        name = "ei_heated-lithium-6",
        amount = ei_data.fusion.plasma_per_unit
    }},
    always_show_made_in = true,
    enabled = false,
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"rocket-control-unit", 1}, {"ei_carbon-structure", 2}, {"ei_steel-mechanical-parts", 8},
                   {"ei_insulated-wire", 6}, {"ei_odd-plating", 4}},
...
data.raw["technology"]["ei_exotic-age"].prerequisites = {"ei_high-tech-parts", "ei_moon-mining", "ei_uran-mining",
                                                         "ei_mars-mining", "ei_sulf-mining", "ei_sun-watching",
                                                         "ei_gas-giant-watching"}
