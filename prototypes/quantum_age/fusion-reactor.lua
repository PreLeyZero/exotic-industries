...
data:extend({{
    ...
    category = "crafting",
    energy_required = 40,
    ingredients = {{"ei_plasma-heater", 2}, {"ei_magnet", 40}, {"refined-concrete", 200}, {"processing-unit", 100},
                   {"ei_fusion-data", 200}, {"ei_lead-plate", 100}},
        ...
        if energy then
            ...
            for temp_mode, temp_mode_value in pairs(temp_modes) do
                ...
                for fuel_injection_mode, fuel_injection_mode_values in pairs(fuel_injection_modes) do
                    ...
                    recipe.name = "ei_fusion-F1:" .. fuel1 .. "-F2:" .. fuel2 .. "-TM:" .. temp_mode .. "-FM:" ..
                                      fuel_injection_mode
                    ...
                    recipe.ingredients[3].amount = energy * temp_mode_value * fuel_injection_mode_values[1] /
                                                       coolant_fuel_value
                    recipe.results[1].amount = energy * temp_mode_value * fuel_injection_mode_values[1] /
                                                   coolant_fuel_value
