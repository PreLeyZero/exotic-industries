        ...
        ammo_type = {
            action = {
                action_delivery = {
                    ...
                    duration = 20,
                    max_length = 20,
                    source_offset = {0, -1.3143899999999999},
                    type = "beam"
                },
                type = "direct"
            },
...
data:extend({{
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"uranium-rounds-magazine", 15}, {"ei_energy-crystal", 15}, {"explosives", 20}},
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"nuclear-reactor", 1}, {"ei_fission-tech", 30}, {"steam-turbine", 1}},
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"personal-laser-defense-equipment", 4}, {"ei_simulation-data", 30}, {"ei_high-energy-crystal", 20}},
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"exoskeleton-equipment", 4}, {"ei_simulation-data", 30}, {"ei_advanced-motor", 20}},
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"ei_electronic-parts", 1}, {"ei_ceramic", 4}, {"ei_crushed-gold", 2}},
    ...
    category = "crafting",
    energy_required = 10,
    ingredients = {{"rocket-control-unit", 1}, {"low-density-structure", 2}, {"ei_steel-mechanical-parts", 4},
                   {"ei_insulated-wire", 2}, {"ei_copper-beam", 4}},
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"ei_module-part", 1}, {"ei_energy-crystal", 1}, {"ei_glass", 2}},
    ...
    category = "crafting",
    energy_required = 6,
    ingredients = {{"plastic-bar", 8}, {"empty-barrel", 1}, {"ei_ceramic", 10}, {"ei_glass", 8}},
    ...
    results = {{
        ...
        type = "fluid",
        name = "ei_liquid-nitrogen",
        amount = 490 * ei_lib.config("barrel:multiplier")
    }},
    always_show_made_in = true,
    enabled = false,
    ...
    category = "crafting",
    energy_required = 24,
    ingredients = {{"ei_simulation-data", 20}, {"ei_space-data", 3}, {"ei_high-energy-crystal", 2},
                   {"ei_computing-unit", 1}},
