...
data:extend({{
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"pipe", 1}, {"ei_ceramic", 2}, {"plastic-bar", 2}},
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"ei_insulated-pipe", 10}, {"steel-plate", 2}},
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"ei_insulated-pipe", 20}, {"steel-plate", 10}, {"ei_lead-plate", 20}, {"plastic-bar", 40}},
