...
data:extend({{
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"burner-inserter", 1}, {"ei_steam-engine", 1}},
...
local pictures_to_shift = {"hand_base_shadow", "hand_closed_shadow", "hand_open_shadow", "hand_base_picture",
                           "hand_closed_picture", "hand_open_picture"}
