...
data:extend({{
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"steel-plate", 1}, {"ei_iron-ingot", 2}, {"ei_copper-ingot", 2}},
...
for i, v in pairs(pipe.heat_glow_sprites) do
    ...
    for j, k in ipairs(pipe.heat_glow_sprites[i]) do
        ...
        if pipe.heat_glow_sprites[i][j].layers then
            ...
            pipe.heat_glow_sprites[i][j].layers[1].hr_version.filename =
                ei_graphics_heat_path .. "heated_connections/" .. "hr-" .. file
            ...
            pipe.heat_glow_sprites[i][j].layers[2].hr_version.filename =
                ei_graphics_heat_path .. "heated_connections/" .. "hr-" .. file
