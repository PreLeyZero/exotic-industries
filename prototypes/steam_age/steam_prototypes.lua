...
data:extend({{
    ...
    category = "ei_crushing",
    energy_required = 1,
    ingredients = {{"ei_iron-mechanical-parts", 1}},
    results = {{
        type = "item",
        name = "ei_crushed-iron",
        amount = 1
    ...
    category = "crafting",
    energy_required = 2,
    ingredients = {{"ei_crushed-coke", 2}, {"ei_crushed-iron", 5}},
    results = {{
        type = "item",
        name = "ei_steel-blend",
        amount = 1
    ...
    category = "crafting",
    energy_required = 2,
    ingredients = {{"ei_iron-beam", 10}, {"pipe", 4}, {"ei_copper-mechanical-parts", 6}},
    results = {{
        type = "item",
        name = "storage-tank",
        amount = 1
