...
data:extend({{
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"iron-plate", 20}, {"ei_iron-mechanical-parts", 10}, {"ei_copper-mechanical-parts", 10},
                   {"ei_steam-engine", 10}, {"boiler", 1}},
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"iron-plate", 20}, {"ei_iron-mechanical-parts", 5}, {"ei_copper-mechanical-parts", 5}},
    ...
    category = "crafting",
    energy_required = 1,
    ingredients = {{"stone", 1}, {"ei_iron-beam", 2}, {"copper-plate", 1}},
    result = "rail",
    result_count = 1,
    enabled = false,
    always_show_made_in = true,
    ...
    pictures = {
        ...
        height = 512,
        direction_count = 128,
        filenames = {ei_graphics_train_path .. "se_cbl_sheet-0.png", ei_graphics_train_path .. "se_cbl_sheet-1.png",
                     ei_graphics_train_path .. "se_cbl_sheet-2.png", ei_graphics_train_path .. "se_cbl_sheet-3.png",
                     ei_graphics_train_path .. "se_cbl_sheet-4.png", ei_graphics_train_path .. "se_cbl_sheet-5.png",
                     ei_graphics_train_path .. "se_cbl_sheet-6.png", ei_graphics_train_path .. "se_cbl_sheet-7.png"},
        line_length = 4,
        lines_per_file = 4,
        shift = {0, -1.125},
        scale = 0.5
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"ei_steam-basic-locomotive", 1}, {"ei_steel-mechanical-parts", 10}, {"steel-plate", 30}},
    ...
    category = "crafting",
    energy_required = 4,
    ingredients = {{"ei_steam-basic-wagon", 1}, {"ei_steel-mechanical-parts", 5}, {"steel-plate", 5}},
    ...
    pictures = {
        ...
        back_equals_front = true,
        direction_count = 64,
        filenames = {ei_graphics_train_path .. "4aw_cw_vc_sheet-0.png",
    ...
    pictures = {
        ...
        back_equals_front = true,
        direction_count = 64,
        filenames = {ei_graphics_train_path .. "4aw_fw_vc_sheet-0.png",
    ...
    pictures = {
        ...
        scale = 0.5,
        direction_count = 128,
        filenames = {ei_graphics_train_path .. "se_krgreen_sheet-0.png",
